...
const services: Array<Service> =
    [
      ...
      },
      {
        ...
        modalText: [
          "Вам будут доступны инструменты для создания проекта ремонта с помощью конструктора, выбора необходимых материалов и оборудования, общения с дизайнерами и специалистами по ремонту, оформление кредита прямо на платформе и отслеживание хода выполняемых работ."
        ],
      },
      {
        title: "Ипотека",
        ...
        modalTitle: "Ипотека",
        modalText: [
          "Вы сможете сравнить предложения различных банков, рассчитать ежемесячные платежи с помощью встроенного калькулятора, загрузить все необходимые документы для подачи заявки, следить за статусом рассмотрения вашей заявки и получить доступ к индивидуальной консультации нашего эксперта."
        ],
      },
      {
